...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/incrypto-io/godash/wire)
...
```bash
$ go get -u github.com/incrypto-io/godash/wire
```
